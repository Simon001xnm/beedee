    ...
    <div className="flex flex-col">
              ...
              <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl border-none bg-secondary/50">
                <CardContent className="p-0 relative">
                  <div className="absolute top-2 right-2 z-10">
                    <Heart className="h-10 w-10 text-primary/20 group-hover:text-primary group-hover:fill-primary transition-colors" />
                  </div>
      ...
      <section className="bg-secondary/50 py-12">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex justify-between items-center mb-8 bg-foreground p-4 rounded-md">
            <h2 className="text-3xl font-headline font-bold text-background">LATEST PRODUCTS</h2>
      ...
      <footer className="bg-secondary/50 text-foreground pt-12 pb-8">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {Object.entries(footerProductLists).map(([title, products]) => (
              <div key={title}>
                <h3 className="font-headline font-bold text-lg mb-4">{title.toUpperCase()}</h3>
