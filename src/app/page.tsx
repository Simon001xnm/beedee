...
import { CreditCard, RefreshCw, Truck, MessageCircle, Star, ArrowRight, ShieldCheck, Gem } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            ...
            <div className="flex items-center gap-10">
              <Button size="lg" className="btn-gold h-16 px-12 rounded-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            <div className="space-y-8 col-span-1 lg:col-span-1">
              ...
              <div className="flex gap-6">
                 <Link href="#" className="h-10 w-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:text-primary transition-all"><MessageCircle className="h-4 w-4"/></Link>
                 <Link href="#" className="h-10 w-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent hover:text-primary transition-all"><Star className="h-4 w-4"/></Link>
              </div>
            </div>
            <div className="space-y-8">
             ...
             <div className="space-y-8">
              ...
              <div className="flex gap-2">
                <input type="email" placeholder="Email Address" className="bg-white/5 border border-white/10 px-4 py-3 text-xs rounded-lg flex-1 outline-none focus:border-accent transition-colors" />
                <Button size="sm" className="bg-accent text-primary font-black text-[9px] tracking-widest px-6 uppercase rounded-lg">JOIN</Button>
              </div>
            </div>
          </div>
