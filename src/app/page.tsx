        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col items-center text-center">
          <div className="max-w-3xl space-y-12">
            <div className="space-y-6">
              ...
              <h3 className="text-5xl md:text-8xl font-headline font-bold leading-[0.9] tracking-tighter uppercase">CRAFTED FOR THE<br/><span className="text-accent">DARING.</span></h3>
            </div>
            <p className="text-white/60 text-lg md:text-2xl font-medium leading-relaxed italic mx-auto">
